...
const AppliedJobs = () => {
    ...
    const getAppliedJobs = async () => {
        ...
        setData(response.data.find.filter((data) =>
            data.CompanyID.name.toLowerCase().includes(keyword.toLowerCase()) || data.JobID.jobTitle.toLowerCase().includes(keyword.toLowerCase())
        ))
    }
                ...
                <header className='header-container'>
                    ...
                    <div className='header-search-container'>
                        <div className='flex items-center w-full space-x-2'>
                            ...
                            />
                            <button className='header-search-button' onClick={getAppliedJobs}>Search</button>
                        </div>
                    </div>
                </header>
