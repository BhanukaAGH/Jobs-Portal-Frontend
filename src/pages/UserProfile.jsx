...
const UserProfile = () => {
  ...
  const add = async (data) => {
    ...
    if (resume === null) {
      setInfo("cv require")
      toast.error("CV should be added", { theme: 'dark' })
      return;
    }
    //get cv file url
    setisLoading(true)
          ...
          <form onSubmit={handleSubmit(add)}>
            <div className='flex justify-center pt-4'>
              <div className="box-border h-auto w-4/5  pt-4 ">
                <div className='flex'>
                  <button type="submit" class=" flex font-medium rounded-md text-white text-md  px-4 py-2.5   bg-[#312ECB] hover:bg-blue-700 focus:outline-none">
                ...
                <div className='pt-12 pl-6 pr-6'>
                    ...
                    <div className='flex'>
                      {resume === null && (
                        <>
                          ...
                          <input type='file' id='file' accept="application/pdf" ref={inputFile} onChange={(e) => setResume(e.target.files[0])} style={{ display: 'none' }}
                          />
                        </>
                      )}
                      {resume !== null && (
                  ...
                  <div className='pt-4'>
                    ...
                    <input type="text" onChange={(e) => { setLocation(e.target.value) }} placeholder='Sri Lanka' className="bg-gray-50 shadow-md  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-full p-2.5"
                      {...register('location', {
                  ...
                  <div className='pt-4'>
                    ...
                    <input type="text" onChange={(e) => { setPrimaryRole(e.target.value) }} placeholder='eg: Student' className="bg-gray-50 shadow-md  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-full  p-2.5"
                      {...register('role', {
                        required: 'Primary Role is required',
                        minLength: {
                          value: 3,
                          message: 'Primary Role must be at least 3 characters',
                        },
                      })}
                    />
                    {errors.role && (
                  ...
                  <div className='pt-4'>
                    ...
                    <textarea type="text" onChange={(e) => { setStatement(e.target.value) }} placeholder='Tell us about you...' className="bg-gray-50  shadow-md border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-full resize-y p-2.5"
                      {...register('statment', {
                        required: 'Personal Statment is required',
                        minLength: {
                          value: 3,
                          message: 'Personal Statmente must be at least 3 characters',
                        },
                      })}
                    />
                  </div>
                  ...
                  <div className='pt-4'>
                    ...
                    <div className='flex'>
                      ...
                      <input type="number" min="0" placeholder='years of experience' onChange={(e) => { setYOE(e.target.value) }} className="bg-gray-50 shadow-md  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-1/5  p-2.5" />
                    </div>
                  </div>
