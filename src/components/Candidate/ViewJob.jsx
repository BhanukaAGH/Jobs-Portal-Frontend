...
const ViewJob = ({ setViewjob }) => {
  ...
  //save method
  const saveJob = async () => {
    if (savedJobs.includes(jobApply.viewData.job._id)) {
      //delete job
      try {
                ...
                <div className='pl-48'>
                  <div className='w-3/4'>
                    ...
                    <h1 className='text-white font-sans text-2xl font-bold'>
                      Company: {jobApply.viewData.job.company.name}
                    </h1>
                    <h1 className='text-white font-sans text-xl font-bold'>
                      Category: {jobApply.viewData.job.jobCategory}
                    </h1>
                  </div>
                </div>
          ...
          <>
            ...
            <div className='pl-10 pr-6'>
              <div className='box-content h-auto w-full  pt-2 '>
                ...
                <p className=''>{jobApply.viewData.job.jobDescription}</p>
              </div>
              <div className='box-content h-auto w-full pt-2 '>
                <div className='pt-6 '>
