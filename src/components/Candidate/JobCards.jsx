...
const JobsCard = () => {
    ...
    const getAllJobs = async () => {
        const API_URL = `${process.env.REACT_APP_API_URL}/api/v1/candidate/getAllJobs?page=${pageNo}`
    ...
    return (
        <>
                        ...
                        <div className=' h-5/6 w-full pl-4 pt-4 bg-white rounded-t-lg '>
                            <div className='flex'>
                                ...
                                <div className='pl-4 grid grid-cols-1 '>
                                    ...
                                    <div><p className="truncate text-sm text-gray-500">{job.jobDescription}</p></div>
                                </div>
                            </div>
                        </div>
                        <div>
            ...
            <div className='flex justify-center pt-6'>
                <button
                    className="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none !ring-0 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 border-blue-500 "
                    onClick={prev}
                >
                    Previous
                </button>
