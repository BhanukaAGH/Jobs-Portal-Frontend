...
const SingleCompany = ({
  ...
  const deleCompany = () => {
    swal({
      ...
      if (willDelete) {
        api.delete(`admin/delete/company/${_id}`);
  ...
  return (
    <article className="h-58 p-6 border-2  border-black rounded-lg w-1/4 mx-3 mb-3">
      ...
      <div className="flex justify-between  items-center">
        <img src={photoUrl} alt="" height={50} width={50} />
      ...
      <div className="flex justify-between  items-center mt-4">
        <button
          className="admin-btn bg-red-600 "
          onClick={() => updateCompany(_id)}
        >
          Update
        </button>
        <button className="admin-btn bg-green-600 " onClick={deleCompany}>
          Delete
        </button>
      </div>
    </article>
